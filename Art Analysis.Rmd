...
```{r}
library(pacman)
p_load(ggplot2,dplyr,stringr,tidyverse,data.table,knitr,caret)
library(lmerTest)
...
Need to install.packages("devtools") - Is there something wrong with Rtools? The software I downloaded from SR-Research?
Somethings wrong with devtools
...
install itrackR
devtools::install_github("jashubbard/itrackR", build_vignettes=True) #what is vignettes?
